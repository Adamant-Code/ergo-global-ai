...
const DifferenceRecordProperty: FC<BasePropertyProps> = ({
  record,
  property,
}) => {
  // Get the unflattened version of the entire record
  const unflattenedParams = flat.unflatten(record?.params ?? {});
...
export default DifferenceRecordProperty;
